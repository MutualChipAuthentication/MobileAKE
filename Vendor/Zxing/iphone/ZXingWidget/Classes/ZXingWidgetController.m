...
{
    [self.overlayView addNavigationBar];
}
//-(void) setTorchAction{
//    
//    if(![self torchIsOn])[self setTorch:YES];
//    else [self setTorch:NO];
//    
//}
- (void)dealloc {
...
- (void)notifyDelegate:(id)text {
     self.overlayView.searchFrame.image = [UIImage imageNamed:@"qr_active.png"];
